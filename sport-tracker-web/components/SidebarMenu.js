      ...
      >
        <div style={{ margin: "40px 0px" }} className="nmsLogoDiv">
          <center>
            {
              !state.collapsed ?
                <img src="/images/logo/sport-tracker.svg" alt="Sport Tracker Logo" /> :
                <img height="35px" src="/images/logo/sport-tracker.svg" alt="Sport Tracker Logo" />
            }
          </center>
        </div>
              ...
              >
                <Link href={route.path}>
                  <a>
                    {
                      isCurrentPath
                        ? <center>{route.iconAct}</center>
                        : <center>{route.icon}</center>
                    }
                  </a>
                </Link>
              </Menu.Item>
